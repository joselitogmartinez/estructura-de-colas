...
public class LinkedListBasedQueue {
	...
	public Object dequeue() {
		if (isEmpty()) {
			throw new NoSuchElementException("No se puede sacar de la cola desde una cola vac�a");
		}
	...
	public Object peek() {
		if (head == null) {
			throw new NoSuchElementException("No se puede mirar desde la cola vac�a");
		}
		return head.item;
	}
